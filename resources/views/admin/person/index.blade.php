...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">List product</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">No product found. Please add products!</h6>
        @endif
      </div>
    </div>
</div>
        ...
        $.ajaxSetup({
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    title: "Are you sure?",
                    text: "If you delete it, this data cannot be recovered!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })

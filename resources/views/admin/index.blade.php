      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success bg-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-white text-uppercase mb-1">Product</div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-danger bg-danger shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-white text-uppercase mb-1">Tạm trú vs Tạm vắng</div>
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
                    <div class="h5 mb-0 mr-3 font-weight-bold text-white">{{$temporaries->where('type', 'residence')->count()}} vs {{$temporaries->where('type', 'absence')->count()}}</div>
                  </div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning bg-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-white text-uppercase mb-1">Số khoản thu</div>
                <div class="h5 mb-0 font-weight-bold text-white">{{$fees->count()}}</div>
              </div>
              <div class="col-auto">
      ...
      <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Tổng quan các khoản thu năm 2023</h6>
...
<!-- Include your other HTML elements and content -->

<!-- Male and Female Count Chart -->
<div class="col-xl-4 col-lg-5">
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Nhân khẩu theo giới tính</h6>
    </div>
    <div class="card-body">
      <div class="chart-pie">
      ...
      <div class="col-lg-12 mb-4">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Khoản thu bắt buộc</h6>
          </div>
          <div class="card-body">
            @foreach($fees as $fee)
    ...
    return $household->members->count('personId');
                ...
                <div class="progress mb-4">
                  <div class="progress-bar bg-{{ $progressPercentage >= 100 ? 'success' : ($progressPercentage >= 80 ? 'info' : ($progressPercentage >= 60 ? 'warning' : 'danger')) }}" role="progressbar" style="width: {{ $progressPercentage }}%" aria-valuenow="{{ $progressPercentage }}" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              @endif
            @endforeach
          </div>
...
<script>
  ...
  <script type="text/javascript">
    const url = "{{route('receipts.income')}}";
